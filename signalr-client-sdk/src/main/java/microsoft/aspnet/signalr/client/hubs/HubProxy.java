...
public class HubProxy {
    ...
    /**
     * create by sunshaoshuai  on 2017/6/17.
     * <p>
     * Processing Java.lang.ClassCastException: com.google.gson.internal.LinkedTreeMap cannot be cast to object
     *
     * @param eventName
     * @param handler
     ...
     * @param <E1>
     */
    private <E1, E2, E3, E4, E5> void on1(String eventName, final SubscriptionHandler5<E1, E2, E3, E4, E5> handler, final TypeToken... parameterTypes) {
        if (handler == null) {
            throw new IllegalArgumentException("handler cannot be null");
        }
        ...
        subscription.addReceivedHandler(new Action<JsonElement[]>() {
            ...
            public void run(JsonElement[] eventParameters) throws Exception {
                ...
                for (int i = 0; i < eventParameters.length; i++) {
                    parameters[i] = mConnection.getGson().fromJson(eventParameters[i], parameterTypes[i].getType());
                }
                method.setAccessible(true);
                method.invoke(handler, parameters);
            }
     ...
     * @param <E1>
     */
    public <E1> void on(String eventName, final SubscriptionHandler1<E1> handler, TypeToken parameter1) {
        on1(eventName, new SubscriptionHandler5<E1, Void, Void, Void, Void>() {
            @Override
            public void run(E1 p1, Void p2, Void p3, Void p4, Void p5) {
                handler.run(p1);
            }
    ...
    public <E1, E2, E3, E4, E5> void on(String eventName, final SubscriptionHandler5<E1, E2, E3, E4, E5> handler, TypeToken<E1> parameter1, TypeToken<E2> parameter2, TypeToken<E3> parameter3, TypeToken<E4> parameter4, TypeToken<E5> parameter5) {
        this.on1(eventName, new SubscriptionHandler5<E1, E2, E3, E4, E5>() {
            public void run(E1 p1, E2 p2, E3 p3, E4 p4, E5 p5) {
                handler.run(p1, p2, p3, p4, p5);
            }
    ...
    public <E1, E2, E3, E4> void on(String eventName, final SubscriptionHandler4<E1, E2, E3, E4> handler, TypeToken<E1> parameter1, TypeToken<E2> parameter2, TypeToken<E3> parameter3, TypeToken<E4> parameter4) {
        this.on1(eventName, new SubscriptionHandler5<E1, E2, E3, E4, Void>() {
            public void run(E1 p1, E2 p2, E3 p3, E4 p4, Void p5) {
                handler.run(p1, p2, p3, p4);
            }
    ...
    public <E1, E2, E3> void on(String eventName, final SubscriptionHandler3<E1, E2, E3> handler, TypeToken<E1> parameter1, TypeToken<E2> parameter2, TypeToken<E3> parameter3) {
        this.on1(eventName, new SubscriptionHandler5<E1, E2, E3, Void, Void>() {
            public void run(E1 p1, E2 p2, E3 p3, Void p4, Void p5) {
                handler.run(p1, p2, p3);
            }
    ...
    public <E1, E2> void on(String eventName, final SubscriptionHandler2<E1, E2> handler, TypeToken<E1> parameter1, TypeToken<E2> parameter2) {
        this.on1(eventName, new SubscriptionHandler5<E1, E2, Void, Void, Void>() {
            public void run(E1 p1, E2 p2, Void p3, Void p4, Void p5) {
                handler.run(p1, p2);
            }
